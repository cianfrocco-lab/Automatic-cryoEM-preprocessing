...
setup(
    ...
    description='Tools to run user-free preprocessing of cryo-EM datasets:'
                ' https://www.biorxiv.org/content/10.1101/2019.12.20.885541v1',  # Required
    ...
    url='https://github.com/cianfrocco-lab/Automatic-cryoEM-preprocessing',  # Optional

    # This should be your name or the name of the organization which owns the
    # project.
    author='Yilai Li, Michael A. Cianfrocco',  # Optional
